...
from colima_helper.gui.actions import SubprocessActions
from colima_helper.gui.bus import set_listeners, listener
from colima_helper.gui.dependency_injection import Container
from colima_helper.gui.events import SubprocessMetricsEvent, ContainerCreatedEvent, \
...
def supervisord_plugin_factory(container_name, container):
    if 'colima-helper-supervisor' not in container['Labels']:
        return None
    config = json.loads(container['Labels']['colima-helper-supervisor'])
